 ...
 */
import { BRANCH_INDEX, STEM_YINYANG, } from "../constants.js";
 ...
 */
export const JANGSAENG_BY_STEM = {
    "甲": "亥", "乙": "午",
    "丙": "寅", "丁": "酉",
    "戊": "寅", "己": "酉",
    "庚": "巳", "辛": "子",
...
const JANGSAENG_OF_GROUP = (() => {
    // 삼합국 오행별 장생지: 水국(申子辰)→申, 木국(亥卯未)→亥,
    // 火국(寅午戌)→寅, 金국(巳酉丑)→巳.
    const startByElement = {
 ...
 */
export function twelveSinsal(ref, branch) {
