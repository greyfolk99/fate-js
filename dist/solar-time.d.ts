 ...
 */
export declare function equationOfTime(year: number, month: number, day: number): number;
/**
 ...
 */
export declare function solarCorrectionMinutes(year: number, month: number, day: number, longitude: number, standardMeridian: number, includeEot: boolean): number;
//# sourceMappingURL=solar-time.d.ts.map